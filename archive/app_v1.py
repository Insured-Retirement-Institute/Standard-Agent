"""
IRI Standards Agent — Standalone Server
...
app = FastAPI(title="IRI Standards Agent")
...
def chat_ui():
    return """<!DOCTYPE html>
<html><head><title>IRI Standards Agent</title>
<style>
...
<h1>IRI Standards Agent</h1>
<p>OpenAPI 3.1 validation, style guide enforcement, and governance scorecard.</p>
<div id="chat"></div>
<div id="input-row">
  <input id="msg" placeholder="Ask about IRI specs..." onkeydown="if(event.key==='Enter')send()">
...
if __name__ == "__main__":
    ...
    print(f"[server] Starting on http://localhost:{port}", flush=True)
